...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-muted-1 [&_tr]:border-0 [&_tr]:shadow-[inset_0_-2px_0] [&_tr]:shadow-muted-10",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t-2 bg-muted-1 font-medium [&>tr]:last:border-b-0",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <caption
    ref={ref}
    className={cn("mt-4 text-sm text-muted-10", className)}
    {...props}
  />
));
